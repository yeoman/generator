...
describe('Ember generator test', function() {
  ...
  describe('create expected files', function() {
    ...
    it('should generate app/scripts/routes/app-router.js', function() {
      helpers.assertFile('app/scripts/routes/app-router.js');
    });
    
    it('should generate app/scripts/store.js', function() {
    ...
    it('should generate app/scripts/vendor/ember-1.0.pre.min.js', function() {
      helpers.assertFile('app/scripts/vendor/ember-1.0.pre.min.js');
    });
    
    it('should generate app/scripts/vendor/handlebars-1.0.0.beta.6.js', function() {
    ...
    it('should generate app/scripts/templates/application.handlebars', function() {
    ...
    it('should generate app/scripts/controllers/application-controller.js', function() {
