...
// todo: flesh out api, remove config (merge with options, or just remove the
...
Base.prototype.hookFor = function hookFor(name, config) {
  ...
  // in help
  this.option(name, {
    desc: this.humanize(name) + ' to be invoked',
...
Base.prototype.optionsHelp = function optionsHelp() {
  var options = this._options.filter(function(o) {
    return !o.hide;
  });
