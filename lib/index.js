...
class Generator extends Base {
  ...
  checkEnvironmentVersion(packageDependency, version) {
    ...
    const returnError = (currentVersion) => {
      return new Error(
        `This generator (${this.options.namespace}) requires ${packageDependency} at least ${version}, current version is ${currentVersion}, try reinstalling latest version of 'yo'`
      );
    };
