 ...
 * @private
 */
const getCheckboxDefault = function (question, defaultValue) {
 ...
 * @private
 */
const getListDefault = function (question, defaultValue) {
  const choiceValues = _.map(question.choices, choice => {
    if (typeof choice === 'object') {
      return choice.value;
    }
    return choice;
 ...
 * @private
 */
const storeListAnswer = function (question, answer, storeAll) {
  const choiceValues = _.map(question.choices, choice => {
 ...
 * @private
 */
const storeAnswer = function (question, answer, storeAll) {
