...
exports.domUpdate = function domUpdate(html, tagName, content, mode) {
...
exports.append = function append(html, tagName, content) {
...
exports.prepend = function prepend(html, tagName, content) {
...
exports.appendToFile = function appendToFile(path, tagName, content) {
...
exports.prependToFile = function prependToFile(path, tagName, content) {
  var html = this.readFileAsString(path);
...
exports.generateBlock = function generateBlock(blockType, optimizedPath, filesBlock, searchPath) {
  var blockStart;
  var blockEnd;
  var blockSearchPath = '';
...
exports.appendFiles = function appendFiles(htmlOrOptions, fileType, optimizedPath, sourceFileList, attrs, searchPath) {
  var blocks;
  var updatedContent;
...
exports.attributes = function attributes(attrs) {
...
exports.appendScripts = function appendScripts(html, optimizedPath, sourceFileList, attrs) {
...
exports.removeScript = function removeScript(html, scriptPath) {
...
exports.appendStyles = function appendStyles(html, optimizedPath, sourceFileList, attrs) {
...
exports.removeStyle = function removeStyle(html, path) {
...
exports.appendScriptsDir = function appendScriptsDir(html, optimizedPath, sourceScriptDir, attrs) {
...
exports.appendStylesDir = function appendStylesDir(html, optimizedPath, sourceStyleDir, attrs) {
...
exports.readFileAsString = function readFileAsString(filePath) {
...
exports.writeFileFromString = function writeFileFromString(html, filePath) {
