...
exports.fetch = function _fetch(url, destination, cb) {
...
exports.extract = function _extract(archive, destination, cb) {
  var opts = {
    extract: true,
    proxy: proxy,
    strip: 1
...
exports.tarball = exports.extract;

/**
 * Expose the request module set up with a proxy
 */

exports.request = request.defaults({ proxy: proxy });
