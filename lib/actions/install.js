...
install.runInstall = function (installer, paths, options, cb) {
    return this.runCommand(installer, 'install', paths, options, cb);
}

// Combine script cmd line arguments and run the action command
//
...
//
// Returns the generator instance.
install.runCommand = function (script, action, paths, options, cb) {
