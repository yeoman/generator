...
// - data        - an optional hash to pass to the template,
//                 if undefined, executes the template in the generator instance context
actions.copy = function copy(source, destination, process, data) {
  var body;
