...
exports.cacheRoot = function cacheRoot() {
...
exports._prepCopy = function _prepCopy(source, destination, process) {
  var body;
...
exports.copy = function copy(source, destination, process) {
...
exports.bulkCopy = function bulkCopy(source, destination, process) {
...
exports.read = function read(filepath, encoding) {
  var contents;
...
exports.write = function write(filepath, content) {
...
exports.checkForCollision = function checkForCollision(filepath, content, cb) {
  this.conflicter.add({
    file: filepath,
    content: content
  });
...
exports.template = function template(source, destination, data) {
  data = data || this;
  destination = destination || source;
...
exports.engine = function engine(body, data) {
  if (!this._engine) {
...
exports._directory = function _directory(source, destination, process, bulk) {
...
exports.directory = function directory(source, destination, process) {
...
exports.bulkDirectory = function directory(source, destination, process) {
  var self = this;
...
exports.remote = function (username, repo, branch, cb, refresh) {
  if (!cb) {
    cb = branch;
    branch = 'master';
  }
